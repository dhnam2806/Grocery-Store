class GroceryData {
  static List<Map<String, dynamic>> groceryProducts = [
    ...
    },
    {
      ...
      'price': 1.99,
      'imageUrl':
          'https://www.jacksonville.com/gcdn/authoring/2017/01/18/NFTU/ghows-LK-6897c679-f0cc-41d1-8241-d3f5f8dbad35-7a9c6006.jpeg?crop=2047,1158,x0,y103&width=2047&height=1158&format=pjpg&auto=webp',
    },
    {
      'id': '3',
      'name': 'Bread',
